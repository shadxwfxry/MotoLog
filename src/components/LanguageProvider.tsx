...
const translations: Translations = {
  ...
  ru: {
    ...
    start_adding: "Начните с добавления первого мотоцикла!",
    last_odometer: "Последний пробег",
    status: "Статус",
    ready: "Готов",
    make: "Марка",
    model: "Модель",
  ...
  uk: {
    ...
    start_adding: "Почніть з додавання першого мотоцикла!",
    last_odometer: "Останній пробіг",
    status: "Статус",
    ready: "Готовий",
    make: "Марка",
    model: "Модель",
