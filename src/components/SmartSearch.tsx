...
export function SmartSearch({ refuels, maintenance }: SmartSearchProps) {
  ...
  return (
    <>
      <div className="space-y-4">
        ...
        <div className="relative">
          <input
            ...
            placeholder={t("ask_ai_placeholder") || "Search the web or ask AI..."}
            className="w-full bg-card border-border border-2 rounded-2xl pl-5 pr-24 py-4 focus:outline-none focus:border-primary transition-all shadow-xl font-medium text-sm"
          />
      ...
      {/* ── Google CSE Full-Screen Modal ── */}
      <GoogleSearchModal
        open={googleSearchOpen}
        query={query}
